...
//   User.create({ name: 'user', password: 'user', email: 'user@example.com' })


//   Category.findOne({ category_name: '家居物業' })
//     .lean()
//     .then(category => categoryId = category._id)

//   Category.findOne({ category_name: 'user' })
//     .lean()
//     .then(user => userId = user._id)

//   for (let i = 1; i <= 3; i++) {
//     const amount = Math.floor(Math.random() * 900 + 1)
//     Record.create({ name: `name-{i}`, userId, categoryId, date: '2023-06-01', amount })
//   }
